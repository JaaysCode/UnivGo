...
import ChoiceModal from "@/components/main/ChoiceModal";
  ...
  return (
    <>
      ...
      <ChoiceModal
        ...
        option1={{ label: "Espacio deportivo", onClick: () => {/* acción para opción 1 */}, icon: <i></i> }}
        option2={{ label: "Área común", onClick: () => {/* acción para opción 2 */}, icon: <i></i> }}
      />
    </>
